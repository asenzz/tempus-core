...
import numpy as np
import svmutil
os.chdir('/home/peters/Work/Tasks/FindOptimalParameters/svrpath_research/epspath-python/')
import epspath
...
y, svm_x = svmutil.svm_read_problem('/home/peters/Work/Tasks/14mar-2017/model1.close.txt')
...
res = epspath.svrpath(x=x, y=y, K=K, Lambda=Lambda, maxIterations = 500000, lambdamin=lambdamin, rho = 1e-9, RBFGamma = gamma);
