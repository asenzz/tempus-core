...
def trainlibmsvm_here_nusvr(gamma_rbf, Lambda, svm_x, svm_y, lengthOfValidationSet):
...
for iterationLevel in range (0,16):
    ...
    m = trainlibmsvm_here_nusvr(gamma_rbf=0.000368044218572, Lambda=1/(335.737614243270968), svm_x= svm_x_init, svm_y= svm_y_init, lengthOfValidationSet=15)

#svm_y_init, svm_x_init = svmutil.svm_read_problem(fileNameModelToLoadFull)
#
#m = trainlibmsvm_here_nusvr(gamma_rbf=0.000368044218572, Lambda=1/(335.737614243270968), eps = 0.000000013879058, svm_x= svm_x_init, svm_y= svm_y_init, lengthOfValidationSet=15)