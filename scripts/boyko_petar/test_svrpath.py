...
def svrpath(x,y,K,eps, Lambda, LeftRegion, ElbowLeft, Center, ElbowRight, RightRegion, alphas, gammas_svrpath, beta0, maxIterations, lambdamin, rho):
    start = time.time()
    n = K.shape[0];
