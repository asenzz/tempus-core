...
$tail -${lastlines} $1 | \
  $egrep '(_Auto epsco is|_Mean Z |pass score .* decon level (0|14|34|60)|Total|Position (46|69|92|115|139),|Recombine.*start row 0|Predictions filtered out|Lambda, gamma tune best score.*decon level (0|14|34|60),|Tuning parameters.*level 22|!Best 0 score.*|Execution time of (Tune.*model 0|Recombine parameters|OEMD FIR)|Offline test offset|Validating [0-9.]+ gamma multipliers, .*level 0)' | \
