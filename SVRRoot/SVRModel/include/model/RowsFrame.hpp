...
public:
    ...
    const DataRow::container &get_data() const
    { return data; }

    DataRow::container &get_data()
    { return data; }
    ...
    {
        value_columns.reserve(value_columns_count);
    }
    ...
    std::string to_string() const
    {
        ...
        ss << "Frame size " << frame_size
           ...
           << ", value columns " << common::to_string(value_columns);
