...
TEST_F(DaoTestFixture, IQScalingFactorWorkflow)
{
    ...
    datamodel::Dataset_ptr ds = std::make_shared<svr::datamodel::Dataset>(0, "JamesMayTestDataset", user1->get_user_name(), iq, std::deque<datamodel::InputQueue_ptr>{}, svr::datamodel::Priority::Normal, "", 1, common::C_default_kernel_max_chunk_size, PROPS.get_multistep_len(), 4, "sym7");
