...
TEST_F(DaoTestFixture, SVRParametersWorkflow)
{
    ...
    bigint dataset_id = 0;
    {
        ...
        datamodel::Dataset_ptr ds = std::make_shared<svr::datamodel::Dataset>(0, "DeconQueueTestDataset", user1->get_user_name(),
                                                                              iq, std::deque<datamodel::InputQueue_ptr>{}, svr::datamodel::Priority::Normal, "", 1, common::AppConfig::C_default_kernel_length, PROPS.get_multistep_len(), decon_levels, "sym7");
...
//        svr::datamodel::ensemble_svr_parameters_t svr_params;
        ...
        {
            datamodel::SVRParameters_ptr params  = std::make_shared<SVRParameters>();
