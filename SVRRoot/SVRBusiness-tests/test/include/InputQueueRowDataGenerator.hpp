...
public:
    InputQueueRowDataGenerator(svr::business::InputQueueService &input_queue_service, svr::datamodel::InputQueue_ptr queue, int numberOfValueColumns, long rowsToGenerate) : _queue(queue),
