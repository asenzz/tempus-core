...
public:
    ...
    static void dummy_decon(
            const datamodel::InputQueue &input_queue, datamodel::DeconQueue &decon_queue, const uint16_t levix, const uint16_t levct, const datamodel::t_iqscaler &iq_scaler);
