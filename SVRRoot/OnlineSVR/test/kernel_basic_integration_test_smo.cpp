        ...
        svr::OnlineMIMOSVR &svr_model)
{
    ...
    PROFILE_INFO(svr_model.learn(training_features, training_labels, true), "Online train");
        ...
        const arma::mat &all_features_mx)
{
    ...
    try {
        PROFILE_INFO(svr_model.train_batch(learning_data_batch, reference_data_batch.col(0)), "Batch train");
    } catch (...) {
        return 100;
    }
