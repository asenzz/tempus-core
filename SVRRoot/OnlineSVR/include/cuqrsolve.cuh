...
double mean(const double *d_in, const size_t n, const cudaStream_t &strm);

double max(const double *d_in, const size_t n, const cudaStream_t strm);

double min(const double *d_in, const size_t n, const cudaStream_t strm);

double unscaled_distance(const double *d_labels, const double *d_predictions, const double sf, const size_t n, const cudaStream_t stm);
...
void h_dyn_gpu_solve(
        const size_t gpu_phy_id, const size_t m, const size_t n, const double *h_K, const double *h_L, double *h_weights,
