...
#define DEFAULT_STABILIZE_ITERATIONS_COUNT "32"
...
#define DEFAULT_CONNECTION_STRING "dbname=svrwave user=svrwave password=svrwave host=/var/run/postgresql"
...
#define DEFAULT_SVRPARAM_KERNEL_TYPE_UINT unsigned(svr::datamodel::kernel_type_e::PATH)
#define DEFAULT_SVRPARAM_LAG_COUNT 1000

constexpr double C_bad_validation = 1e6;
constexpr unsigned CUDA_TILE_WIDTH = 32; // For Path kernel must be 32x32 == 1024 == Nx_local or 16 x 16 = 256, careful!
constexpr unsigned CUDA_BLOCK_SIZE = CUDA_TILE_WIDTH * CUDA_TILE_WIDTH;
