...
constexpr uint16_t C_default_kernel_max_chunk_len = 10000; // Matrices larger than 65535x65535 will require ILP64 indexing and CUDA kernels modified for 2D indexing
