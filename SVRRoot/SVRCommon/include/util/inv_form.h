//
// Created by zarko on 10/4/22.
//

#ifndef SVR_INV_FORM_H
#define SVR_INV_FORM_H
...
double
cpu_invnorm(const double p) // For simulation of normal distribution
{
    double x;
    double q, r, u, e;
    x = 0;
