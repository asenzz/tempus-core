...
public:
    explicit AsyncDQScalingFactorDAO(common::PropertiesReader &tempus_config, dao::DataSource &data_source);
    ...
    virtual datamodel::dq_scaling_factor_container_t find_all_by_model_id(const bigint model_id);
