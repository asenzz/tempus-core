...
public:
    explicit AsyncSVRParametersDAO(common::PropertiesReader &sql_properties, dao::DataSource &data_source);
    ...
    get_svrparams(const bigint dataset_id, const std::string &input_queue_column_name, const size_t decon_level, const size_t step);
