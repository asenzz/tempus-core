...
AsyncDQScalingFactorDAO::AsyncDQScalingFactorDAO(common::PropertiesReader& tempus_config, dao::DataSource& data_source)
...
datamodel::dq_scaling_factor_container_t AsyncDQScalingFactorDAO::find_all_by_model_id(const bigint model_id)
{
    const std::scoped_lock lg(pImpl.pgMutex);
