...
std::vector<datamodel::InputQueue_ptr> TsInputQueueDAO::get_all_user_queues(const std::string& user_name)
{
    return ts_call<std::vector<datamodel::InputQueue_ptr>>(&InputQueueDAO::get_all_user_queues, user_name);
}


std::vector<datamodel::InputQueue_ptr> TsInputQueueDAO::get_all_queues_with_sign(bool uses_fix_connection)
{
    return ts_call<std::vector<datamodel::InputQueue_ptr>>(&InputQueueDAO::get_all_queues_with_sign, uses_fix_connection);
}
...
std::vector<std::shared_ptr<std::string>> TsInputQueueDAO::get_db_table_column_names(const datamodel::InputQueue_ptr& queue)
{
