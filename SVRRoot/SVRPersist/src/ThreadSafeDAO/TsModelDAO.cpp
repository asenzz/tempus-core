...
std::deque<datamodel::OnlineSVR_ptr> TsModelDAO::get_svr_by_model_id(const bigint model_id)
{
    return ts_call<std::deque<datamodel::OnlineSVR_ptr>>(&ModelDAO::get_svr_by_model_id, model_id);
}
