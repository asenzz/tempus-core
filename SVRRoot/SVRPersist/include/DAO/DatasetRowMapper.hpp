...
public:
    datamodel::Dataset_ptr map_row(const pqxx_tuple& row_set) const override
    {
        return ptr<datamodel::Dataset>(
                ...
                row_set["residual_coef"].as<double>(common::C_default_residual_coef),
                row_set["gradients"].as(common::C_default_gradient_count),
                row_set["max_chunk_size"].as<size_t>(0),
                row_set["steps"].as(common::C_default_steps),
                row_set["levels"].as(common::C_default_level_count),
                row_set["deconstruction"].as<std::string>(),
                row_set["max_gap"].as(common::C_default_features_max_time_gap),
    ...
    datamodel::Dataset_ptr map_row(duckdb_result& row_set, const size_t col_count, const size_t row) const override
    {
        return ptr<datamodel::Dataset>(
            ...
            common::dd_get_value(row_set, row, col_count, "residual_coef", common::C_default_residual_coef),
            ...
            common::dd_get_value(row_set, row, col_count, "levels", common::C_default_level_count),
