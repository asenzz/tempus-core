...
public:
    datamodel::Model_ptr map_row(const pqxx_tuple &row_set) const override
    {
        return ptr<datamodel::Model>(
                ...
                row_set["last_modified_time"].as<bpt::ptime>(bpt::second_clock::local_time()),
    ...
    datamodel::Model_ptr map_row(duckdb_result& row_set, const size_t col_count, const size_t row) const override
    {
        return ptr<datamodel::Model>(
            ...
            common::dd_get_value(row_set, row, col_count, "decon_level", std::string()),
            common::dd_get_value(row_set, row, col_count, "step", std::string()),
            PROPS.get_multiout(),
            common::dd_get_value(row_set, row, col_count, "gradients", double(0)),
            common::AppConfig::C_default_kernel_length,
            std::deque<datamodel::OnlineSVR_ptr>{},
            common::dd_get_value<bpt::ptime>(row_set, row, col_count, "last_modified_time", bpt::second_clock::local_time()),
