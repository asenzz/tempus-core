...
function initGrid() {
    $("#" + gridId).jqGrid({
        ...
        colModel: [
            ...
            { label: 'Gradients', name: 'levels', width: 75 },
            { label: 'Chunk size', name: 'levels', width: 75 },
            { label: 'Multiout', name: 'levels', width: 75 },
            { label: 'Levels', name: 'levels', width: 75 },
            { label: 'SWT Wavelet', name: 'deconstruction', width: 75 },
