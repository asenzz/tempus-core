...
extern int step_decompose_matrix(const std::vector<double> &phase_cos, const std::vector<double> &phase_sin, size_t len, CPTRd values, const std::vector<double> &previous,
...
int create_solve_problem(size_t K, size_t n, CPTRd previous, const double *values, const double *phase_cos, const double *phase_sin, arma::mat &H, arma::mat &f, arma::mat &A, arma::mat &b,
