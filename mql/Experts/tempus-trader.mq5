...
input int Stop_Day = 7; // Stop trading after the N-th hour of the N-th day of the week
...
void OnTick()
{
    ...
    if (current_server_time >= current_bar_time + C_period_seconds - C_forecast_offset && current_bar_time >= G_pending_request_time) {
